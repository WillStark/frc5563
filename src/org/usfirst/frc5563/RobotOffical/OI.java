...
public class OI {
    ...
    public OI() {
      ...
      /*SmartDashboard.putData("Autonomous Middle", new AutonomousCommandM());
        SmartDashboard.putData("Autonomous Left", new AutonomousCommandL());
        SmartDashboard.putData("Autonomous Right", new AutonomousCommandR()); /* */
